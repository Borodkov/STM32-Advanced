...
static void GUI_Callback(WM_MESSAGE *pMsg) {
    ...
    switch (pMsg->MsgId) {
        case WM_INIT_DIALOG:
            ...
            RADIO_SetText(hItem, "2048", 0);
            RADIO_SetText(hItem, "512", 1);
            RADIO_SetText(hItem, "128", 2);
            ...
            RADIO_SetText(hItem, "Cmpl f32", 0);
            RADIO_SetText(hItem, "Real f32", 1);
